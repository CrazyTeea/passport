        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col m-auto">
              ...
              <b-dropdown variant="transparent" menu-class="dropdown-menu" toggle-class=" text-decoration-none"
                          no-caret>
                ...
                <b-dropdown-item :href="isAdmin ? `/admin/org-info/${id_org}` : '/org-info'">Сведения об организации
                </b-dropdown-item>
                <b-dropdown-item :href="isAdmin ? `/admin/area-info/${id_org}` : '/area-info'">Сведения о колличесве
                  мест и площади
                </b-dropdown-item>
                <b-dropdown-item :href="isAdmin ? `/admin/living-info/${id_org}` : '/living-info'">Сведения о
                  проживающих
                </b-dropdown-item>
                ...
                <b-dropdown-item :href="isAdmin ? `/admin/objects-info/${id_org}` : '/objects-info'">Сведения о жилом
                  объекте
                </b-dropdown-item>
                <b-dropdown-item :href="isAdmin ? `/admin/objects-area/${id_org}` : '/objects-area'">Сведения о площади,
                  проживающих <br> и колличестве мест
                </b-dropdown-item>
                <b-dropdown-item :href="isAdmin ? `/admin/objects-money/${id_org}` : '/objects-money'">Сведения о
                ...
                <b-dropdown-item :href="isAdmin ? `/admin/documents/${id_org}` : '/documents'">
                  {{ isAdmin ? 'Документы' : 'Загрузить документы' }}
                </b-dropdown-item>
